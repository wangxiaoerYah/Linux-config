...
function d_fn_webhook() {
	download_and_check \
		"94-webhook.hook" \
		"root/etc/pacman.d/hooks/" \
		"/etc/pacman.d/hooks/94-webhook.hook"
}

function d_fn_postgresql() {
	download_and_check \
		"95-postgresql.hook" \
		"root/etc/pacman.d/hooks/" \
		"/etc/pacman.d/hooks/95-postgresql.hook"
	download_and_check \
		"96-postgresql.hook" \
		"root/etc/pacman.d/hooks/" \
		"/etc/pacman.d/hooks/96-postgresql.hook"
	download_and_check \
		"97-postgresql.hook" \
		"root/etc/pacman.d/hooks/" \
		"/etc/pacman.d/hooks/97-postgresql.hook"
	download_and_check \
		"98-postgresql.hook" \
		"root/etc/pacman.d/hooks/" \
		"/etc/pacman.d/hooks/98-postgresql.hook"
}
...
function d_fn_redis() {
	download_and_check \
		"97-redis.hook" \
		"root/etc/pacman.d/hooks/" \
		"/etc/pacman.d/hooks/94-redis.hook"
}
...
function main() {
	local check_packages=("webhook" "postgresql" "redis")
